...
![](images/great_expectations.png){fig-alt="Comic from Monkeyuser.com showing too many bugs to fix during first day of release." fig-align="center" width="50%"}

[[Great Expectations](https://www.monkeyuser.com/2019/great-expectations/){target="_blank"} from [MonkeyUser.com](https://www.monkeyuser.com/){target="_blank"}]{style="font-size: 80%;"}
